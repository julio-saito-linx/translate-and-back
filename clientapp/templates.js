...
exports["body"] = function tmpl_body(locals) {
    var buf = [];
    buf.push('<body><div class="container"><nav role="navigation" class="navbar navbar-default"><div class="container-fluid"><!--<Brand>and toggle get grouped for better mobile display </Brand>--><div class="navbar-header"><button type="button" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" class="navbar-toggle"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a href="/" class="navbar-brand">Translation and Back(bone)</a></div><!--<Collect>the nav links, forms, and other content for toggling </Collect>--><div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse"><ul class="nav navbar-nav"><li><a href="/" class="route">config</a></li><li><a href="/result" class="route">result</a></li><li><a href="/collections" class="route">collection demo</a></li></ul><ul class="nav navbar-nav navbar-right"><li><li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Language<b class="caret"></b></a><ul class="dropdown-menu"><li><a href="ar" class="language"> Arabic</a><a href="bg" class="language"> Bulgarian</a><a href="ca" class="language"> Catalan</a><a href="zh-CHS" class="language"> Chinese Simplified</a><a href="zh-CHT" class="language"> Chinese Traditional</a><a href="cs" class="language"> Czech</a><a href="da" class="language"> Danish</a><a href="nl" class="language"> Dutch</a><a href="en" class="language"> English</a><a href="et" class="language"> Estonian</a><a href="fi" class="language"> Finnish</a><a href="fr" class="language"> French</a><a href="de" class="language"> German</a><a href="el" class="language"> Greek</a><a href="ht" class="language"> Haitian Creole</a><a href="he" class="language"> Hebrew</a><a href="hi" class="language"> Hindi</a><a href="mww" class="language"> Hmong Daw</a><a href="hu" class="language"> Hungarian</a><a href="id" class="language"> Indonesian</a><a href="it" class="language"> Italian</a><a href="ja" class="language"> Japanese</a><a href="tlh" class="language"> Klingon</a><a href="tlh-Qaak" class="language"> Klingon (pIqaD)</a><a href="ko" class="language"> Korean</a><a href="lv" class="language"> Latvian</a><a href="lt" class="language"> Lithuanian</a><a href="ms" class="language"> Malay</a><a href="mt" class="language"> Maltese</a><a href="no" class="language"> Norwegian</a><a href="fa" class="language"> Persian</a><a href="pl" class="language"> Polish</a><a href="pt" class="language"> Portuguese</a><a href="ro" class="language"> Romanian</a><a href="ru" class="language"> Russian</a><a href="sk" class="language"> Slovak</a><a href="sl" class="language"> Slovenian</a><a href="es" class="language"> Spanish</a><a href="sv" class="language"> Swedish</a><a href="th" class="language"> Thai</a><a href="tr" class="language"> Turkish</a><a href="uk" class="language"> Ukrainian</a><a href="ur" class="language"> Urdu</a><a href="vi" class="language"> Vietnamese</a><a href="cy" class="language"> Welsh</a></li></ul></li></li></ul></div></div></nav><main id="pages"></main></div></body>');
    return buf.join('');
};
